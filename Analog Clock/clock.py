...
class Clock:
    def __init__(self, root):
        ...
        title=Label(self.root, text="Rishav's Analog Clock", font=("times new roman", 50, "bold"), bg="#04444a", fg="white").place(x=0, y=50, relwidth=1)

        self.lbl=Label(self.root, bg="white", bd=10, relief=RAISED)
        self.lbl.place(x=450, y=150, height=400, width=400)
        #self.clock_image()  #021e2f
        self.working()
